...
class FFmpegProcessor:
    def process_segment(self, input_path: str, output_path: str, start_time: str, end_time: str, srt_content: str = None):
        """
        ...
        try:
            ...
            if srt_content:
                ...
                # Force_style adds basic styling (Yellow text, bold)
                style = "Fontname=Arial,FontSize=24,PrimaryColour=&H00FFFF00,OutlineColour=&H00000000,BorderStyle=1,Outline=1,Shadow=0,MarginV=20"
